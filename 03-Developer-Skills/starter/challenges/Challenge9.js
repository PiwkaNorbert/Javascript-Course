...
const temperatureWeek1 = [17, 21, 23];
const temperatureWeek2 = [12, 5, -5, 0, 4];
const temperatureCombine = temperatureWeek1.concat(temperatureWeek2);
...
printForecast(temperatureCombine);
*/
